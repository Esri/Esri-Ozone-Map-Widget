define(["cmwapi/Channels", "cmwapi/Validator", "cmwapi/map/Error", "cmwapi/map/Status", "cmwapi/map/Overlay",
     ...
     *
     * Pattern of usage
     *      m1: map.status.request.addHandler
     *      w1: map.status.view.addHandler
     *      w1: map.status.request.send  &#123;types: [view]&#125;
     *      m1: receive map.status.request - handler is called
     *      m1: map.status.view.send &#123;requester: w1, ... &#125;
