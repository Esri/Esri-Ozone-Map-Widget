define(["cmwapi/Channels", "cmwapi/Validator"], function(Channels, Validator) {
     ...
     *
     * @description The Show module provides methods for using an overlay show OWF Eventing channel
    ...
    var Show = {
         ...
         * @return {module:cmwapi/map/overlay/Show~Handler} The original event handler wrapped in CMWAPI payload validation code.
