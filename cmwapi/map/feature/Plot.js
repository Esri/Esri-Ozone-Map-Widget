define(["cmwapi/Channels", "cmwapi/Validator"], function(Channels, Validator) {
    ...
    var Plot = {
         ...
         * @param {string} data.featureId The ID of the feature.  If a valid ID string is not specified, the sending widget's ID is used.
        ...
        send : function ( data ) {
            ...
            for (var i = 0; i < payload.length; i ++) {
                // The featureId is optional; defaults to widget id if not specified.
        ...
        addHandler : function (handler) {
            ...
            var newHandler = function( sender, msg ) {
                ...
                for (var i = 0; i < data.length; i ++) {
                    // The featureId is optional; defaults to widget id if not specified.
                    data[i].overlayId = (data[i].overlayId) ? data[i].overlayId : OWF.getInstanceId();
