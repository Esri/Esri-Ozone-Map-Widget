define(["cmwapi/Channels", "cmwapi/Channel", "cmwapi/Validator", "cmwapi/map/Error"], 
    function(Channels, Channel, Validator, Error) {
     ...
     *
     * @module cmwapi/map/feature/Plot
     */

    /**
     * @constructor
     * @alias module:cmwapi/map/feature/Plot
     */
    var Plot = function() {
        Channel.call( this, Channels.MAP_FEATURE_PLOT );
        return( this );
    };

    Plot.prototype = Object.create( Channel.prototype );
     ...
     */
    Plot.prototype.send = function ( data ) {
     ...
     *
     */
    Plot.prototype.addHandler = function (handler) {
