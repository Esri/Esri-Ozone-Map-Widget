define(["cmwapi/Channels", "cmwapi/Validator", "cmwapi/map/Error"], function(Channels, Validator, Error) {
     ...
     * @version 1.1
     *
     * @exports cmwapi/map/feature/status/Start
     */
    var Start = {
        ...
        send: function(data) {
            ...
            if (!validData.result) {
                Error.send( OWF.getInstanceId(), Channels.MAP_FEATURE_STATUS_START, data,
                    validData.msg);
                return;
            }
        ...
        /**
         * Subscribes to the feature.status.start channel and registers a handler to be called when
         * messages are published to it.
         *
         * @param {module:cmwapi/map/feature/status/Start~Handler} handler
         * @return {module:cmwapi/map/feature/status/Start~Handler} The original event handler provided
