define(["cmwapi/Channels", "cmwapi/Validator", "cmwapi/map/Error"],
    ...
    var Unplot = {
         ...
         * @return {module:cmwapi/map/feature/Unplot~Handler} The original event handler wrapped in CMWAPI payload validation code.
        ...
        addHandler : function (handler) {
            ...
            var newHandler = function( sender, msg ) {
                ...
                if (validData) {
                    ...
                    Error.send(jsonSender.id, Channels.MAP_FEATURE_UNPLOT,
                        msg,
                        errorMsg);
                }
