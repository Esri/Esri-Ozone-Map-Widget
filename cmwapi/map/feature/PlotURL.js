define(["cmwapi/Channels", "cmwapi/Validator", "cmwapi/map/Error"],
    ...
    var PlotURL = {
         ...
         * @return {module:cmwapi/map/feature/PlotURL~Handler} The original event handler wrapped in CMWAPI payload validation code.
        ...
        addHandler: function(handler) {
            ...
            var newHandler = function( sender, msg ) {
                ...
                if (validData) {
                    ...
                    Error.send(jsonSender.id, Channels.MAP_FEATURE_PLOT_URL, msg, errorMsg);
                }
