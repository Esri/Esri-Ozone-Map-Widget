define(["cmwapi/Channels", "cmwapi/Validator", "cmwapi/map/Error"], 
    ...
    /**
     * The CenterBounds module provides methods for centering a map on a bounding box via an OWF Eventing channel
        ...
        addHandler : function (handler) {
            ...
            var newHandler = function( sender, msg ) {
                ...
                if (validData.result) {
                    ...
                    Error.send(sender, Channels.MAP_VIEW_CENTER_BOUNDS, 
                        msg,
                        validData.msg);
                }
