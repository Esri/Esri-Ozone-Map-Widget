define(["cmwapi/Channels", "cmwapi/Validator", "cmwapi/map/Error"],
    ...
    var Clicked = {
         ...
         * @return {module:cmwapi/map/view/Clicked~Handler} The original event handler wrapped in CMWAPI payload validation code.
        ...
        addHandler : function (handler) {
            ...
            var newHandler = function( sender, msg ) {
                ...
                if (validData.result) {
                    ...
                    Error.send(jsonSender.id, Channels.MAP_VIEW_CLICKED,
                        msg,
                        validData.msg);
                }
