define(["cmwapi/Channels", "cmwapi/Validator", "cmwapi/map/Error"],
    ...
    var CenterFeature = {
         ...
         * @return {module:cmwapi/map/view/CenterFeature~Handler} The original event handler wrapped in CMWAPI payload validation code.
        ...
        addHandler : function (handler) {
            ...
            var newHandler = function( sender, msg ) {
                ...
                if (validData.result) {
                    ...
                    Error.send(jsonSender.id, Channels.MAP_VIEW_CENTER_FEATURE,
                        msg,
                        validData.msg);
                }
