define(["cmwapi/Channels", "cmwapi/map/feature/Hide", "cmwapi/map/Error", "cmwapi/Validator",
    ...
    describe(Channels.MAP_FEATURE_HIDE + " module", function() {
        ...
        it("sends data to the correct channel", function() {
            ...
            Hide.send({featureId:"myFeatureId"});
            expect(Hide.send).toHaveBeenCalled();

            // expect publish to be called
            expect(eventing.publish).toHaveBeenCalled();
            expect(eventing.publish.mostRecentCall.args[0]).toEqual(Channels.MAP_FEATURE_HIDE);
        ...
        it("unsubscribes the correct channel when removeHandlers is called", function() {
            ...
            expect(eventing.unsubscribe.mostRecentCall.args[0]).toEqual(Channels.MAP_FEATURE_HIDE);
        ...
        it("wraps added handlers and passes along any optional elements; a missing overlayId is filled in", function() {
            ...
            expect(eventing.subscribe.mostRecentCall.args[0]).toEqual(Channels.MAP_FEATURE_HIDE);
